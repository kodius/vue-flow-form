  ...
  <div class="vff" :class="{'vff-not-standalone': !standalone, 'vff-is-mobile': isMobile, 'vff-is-ios': isIos}">
    <div class="f-container">
      <div class="f-form-wrap">
        ...
        <div class="up-equity-logo">
          <img src="https://user-images.githubusercontent.com/17185440/100256491-23837a00-2f45-11eb-847b-b13aaf5018a7.png" alt="upequity-logo">
        </div>
...
<style lang="css">
  ...
  @import '../assets/css/themes/theme-kodius.css';
</style>